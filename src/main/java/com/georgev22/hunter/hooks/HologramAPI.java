...
public class HologramAPI implements Holograms {
    ...
    private final HologramPool hologramPool = new HologramPool(hunterPlugin, 70, 0, 0);
    ...
    public void updateAll() {
        ...
        for (String hologramName : Objects.requireNonNull(data.getConfigurationSection("Holograms")).getKeys(false)) {
            ...
            int i = 0;
            for (String line : hunterPlugin.getConfig().getStringList("Holograms." + data.getString("Holograms." + hologramName + ".type"))) {
